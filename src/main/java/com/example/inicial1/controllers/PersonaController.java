...
@RestController //LA CLASE SE COMPORTA SEMANTICAMENTE COMO UN CONTROLADOR
@RequestMapping("/personas")// PUNTO DE ENTRADA A MI API
public class PersonaController {
 //  @Autowired
//PersonaServices servicio;

    @GetMapping("") //SI NO LE PONGO NADA-->(POR DEFECTO)ME TOMA LA RUTA DEL REQUEST MAPPING
    ...
    @GetMapping("/{id}")       //ACA LE PASO UNA VARIABLE, capturo por id y lo traigo, atrapo el objeto por id, busco por id
